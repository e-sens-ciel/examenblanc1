export const bds = [
  ...
  },
  {
    ...
    resume:
      "Découvrer la réjouissante aventure d'un couple explosif imaginé par un vrai couple dans la vie.Partout, femmes et hommes fonts des étincelles",
    type: 'manga',
    etat: 'bon',
    isbn: 9782290161791,
    prix: 11.9,
  ...
  },
  {
    ...
    serie: null,
    resume:
      "Ce fut un temps d'avant le vôtre... A la frontière de notre monde et des horizons inconnus... Là où le savoir de l'homme s'arrête... Là où celui des rêveurs commence... Un temps que seuls les magiciens peuvent comprendre. ",
    type: 'bd',
    etat: 'neuf',
    image: 'La-Foret.jpg',
    isbn: 9782203391598,
  ...
  },
  {
    ...
    prix: 10.7,
    resume:
      "Caché u coeur d'histoire Naturelle se trouve le cabinet d'Enola, une vétérinaire hors du commun.\nSa spécilalité?\nLes animaux des contes et légendes!",
    type: 'bd',
  ...
  },
  {
    ...
    serie: null,
    resume:
      "L’époque des cow-boys tire à sa fin. Bientôt, ce sont les trains qui mèneront les vaches jusqu'aux abattoirs de Chicago. Accompagné de Benett, un jeune simplet de 20 ans, Russell a décidé de raccrocher ses éperons pour devenir fermier dans le Montana.",
    type: 'bd',
    etat: 'neuf',
    isbn: 9782818967003,
